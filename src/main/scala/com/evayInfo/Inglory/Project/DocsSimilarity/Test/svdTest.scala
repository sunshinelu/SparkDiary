...
import com.evayInfo.Inglory.Project.DocsSimilarity.DocsimiSVD.{distributedRowsNormalized, multiplyByDiagonalMatrix, multiplyByDiagonalRowMatrix, rowsNormalized}
import com.evayInfo.Inglory.Project.DocsSimilarity.Test.TfIdfTest2.SetLogger
