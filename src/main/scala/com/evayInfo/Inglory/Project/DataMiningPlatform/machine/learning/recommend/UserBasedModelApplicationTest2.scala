 ...
 */
object UserBasedModelApplicationTest2 {
...
//    val test_table = "recommenderSys_Demo_Data_sample"
    ...
    val opt_table = "recommenderSys_Demo_Data_sample_user_based_TopNProductsForUsers"

    val recom = new UserBasedModelApplication()
