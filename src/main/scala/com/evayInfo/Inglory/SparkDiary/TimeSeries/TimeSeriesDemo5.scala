 ...
 * https://github.com/sryza/spark-ts-examples/blob/master/jvm/src/main/scala/com/cloudera/tsexamples/Stocks.scala
 *
 */
object TimeSeriesDemo5 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val tickerObs = loadObservations(sqlContext, "/Users/sunlu/Documents/workspace/IDEA/SparkDiary/data/ts_data/ticker.tsv")
